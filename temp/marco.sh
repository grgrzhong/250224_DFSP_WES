...
export vcf_dir="/home/zhonggr/projects/250224_DFSP_WES/data/wes/preprocessing/recalibrated"
...
mutect_call_filter() {
    ...
    perl ${ref_dir}/annovar/table_annovar.pl $VAROUT/${tumour_id}.final.vcf.gz \
    ...
    # rm $VAROUT/${tumour_id}_filtered.vcf.gz.tbi
