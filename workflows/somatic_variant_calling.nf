...
// BWA index files
params.bwa_index_amb            = params.genomes[params.genome]?.bwa_index_amb
params.bwa_index_ann            = params.genomes[params.genome]?.bwa_index_ann
params.bwa_index_bwt            = params.genomes[params.genome]?.bwa_index_bwt
params.bwa_index_pac            = params.genomes[params.genome]?.bwa_index_pac
params.bwa_index_sa             = params.genomes[params.genome]?.bwa_index_sa
...
workflow {
    ...
    */
    ...
    // Fastq preprocessing and baw alignment
    // PREPROCESSING(
    //     fastq,
    //     fasta,
    //     fai,
    ...
    // Mutect2 variant calling, filtering and annotation
    // MUTECT2_CALL(
    //     bam_tumour_normal,
    //     bam_tumour_only,
    //     fasta,
